...
class WizardLedger(models.TransientModel):
    _name = 'wizard.ledger.ecosoft'
    ...
    def print_report(self, data):
        data.setdefault('form',{})
        data['form'].update(self.read(['choose_period','date_from','date_to', 'only_balance'])[0])        
        return self.env.ref('account_reports_ecosoft.action_report_ledger_ecosoft').report_action(self, data=data)
        #return self.env['report'].get_action(False, 'account.report_ledger_ecosoft', data=data)
